...
const Customer = () => {
  ...
  return (
    <div className="customer-layout"> {/* Cambié la clase para distinguir */}
      {/* Sidebar dinámico según rol (solo muestra accesos cliente si es cliente) */}
      <Sidebar />

      {/* Sección principal */}
      <div className="customer-content"> {/* Encapsula el contenido principal */}
